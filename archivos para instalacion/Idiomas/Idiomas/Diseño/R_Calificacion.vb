...
Public Class R_Calificacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Idiomas.R_Calificacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_N_Control() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_Calificacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Calificacion = New R_Calificacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
