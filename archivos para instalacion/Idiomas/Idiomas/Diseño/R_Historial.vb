...
Public Class R_Historial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Idiomas.R_Historial.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Numero_de_Control() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_Historial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Historial = New R_Historial()
        rpt.Site = Me.Site
        Return rpt
    End Function
